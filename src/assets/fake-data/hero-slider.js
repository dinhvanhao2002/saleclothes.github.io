const img1 = require("../images/slider/banner3.jpg").default
const img2 = require("../images/slider/banner2.png").default
const img3 = require("../images/slider/banner2.png").default


const heroSliderData = [
    {
        title: "Polo nam Yody cao cấp",
    ...
    {
        title: "Polo Nam Dáng Suông Modal",
    ...
    {
        title: "Polo Nam Coolmax Lacoste",
        description: "Mẫu áo polo nam được làm bằng chất liệu coolmax đem lại cảm giác mát lạnh khi mặc. Thiết kế mẫu áo polo coolmax này có kiểu dáng cực kỳ thoải mái. Tạo sự gọn gàng hứa hẹn sẽ là mẫu áo polo vô cùng hot trong thời điểm sắp tới",
        img: img3,
